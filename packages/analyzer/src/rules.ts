...
export const REGEX_RULES: RegexRule[] = [
  {
    ...
    severity: 'high',
    message: '강조 도입어. 무겁게 운만 떼고 정작 정보는 안 줌. AI 전형 패턴',
...

  {
    ...
    severity: 'medium',
    message: '"다음과 같이" 콜론 제목. 본문 대신 틀이 자리를 먹음. AI 출력 형식',
  ...
  },
  {
    ...
    severity: 'low',
    message: '물결표 범위. 렌더러에 따라 취소선으로 깨지고, AI가 범위에 즐겨 씀',
...

  {
    ...
    severity: 'high',
    message: '이중피동. 행위 주체가 흐려지고 문장이 늘어짐',
  ...
  },
  {
    ...
    severity: 'high',
    message: '"~에 의해 …되다" 수동문. 행위자가 가려지고 문장이 무거워짐. AI 생성문에 잦음',
  ...
  },
  {
    ...
    re: /(?:를|을) 가지고 있/g,
    severity: 'high',
    message: '"~을 가지고 있다". 한 박자 늘어지는 군더더기',
    suggestion: '"~이 있다"',
  },
  ...
  },
  {
    ...
    re: /로부터 /g,
    severity: 'medium',
    message: '"~로부터". 한 박자 무거워짐. "에서·에게"면 충분',
    suggestion: '"~에서" 또는 "~에게"',
  },
  {
    id: 'D1.in_doing',
  ...
  },
  {
    ...
    severity: 'medium',
    message: '"의미가 도달한다" 류. 독자에게 안 닿는 추상 표현. AI가 즐겨 씀',
  ...
  },
  {
    ...
    severity: 'medium',
    message: '이중 조사. 조사를 겹쳐 문장이 굳음. 하나면 풀림',
